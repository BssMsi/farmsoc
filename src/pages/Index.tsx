...
const Index = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-farmsoc-primary text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-6">FarmSoc</h1>
          <p className="text-xl mb-8">
            Connecting farmers directly with consumers, eliminating intermediaries
          </p>
          <Link 
            to="/app/auth/login" 
            className="inline-flex items-center bg-white text-farmsoc-primary font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition-colors"
          >
            Get Started
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">How FarmSoc Works</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-farmsoc-light rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-farmsoc-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-farmsoc-primary">For Consumers</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-farmsoc-primary mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-farmsoc-primary">For Farmers</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-farmsoc-primary mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-farmsoc-primary">For Influencers</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-farmsoc-primary mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <div className="py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/app/auth/login" 
              className="bg-farmsoc-primary text-white font-semibold px-6 py-3 rounded-md hover:bg-farmsoc-dark transition-colors"
            >
              Log In
            </Link>
            <Link 
              to="/app/auth/signup" 
              className="bg-white text-farmsoc-primary font-semibold px-6 py-3 rounded-md border border-farmsoc-primary hover:bg-farmsoc-light transition-colors"
            >
              Sign Up
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="text-xl font-bold mb-2">FarmSoc</h3>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} FarmSoc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
