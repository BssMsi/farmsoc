    ...
    <div className="h-full bg-gray-50 pb-16">
      ...
      <div className="bg-white p-4 shadow-sm">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-farmsoc-light p-3 rounded-lg">
            <div className="flex items-center text-farmsoc-dark">
      ...
      <div className="p-4">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-3">
            ...
            <button 
              className="text-farmsoc-primary text-sm font-medium"
          ...
          {isProductsLoading ? (
            <div className="text-center p-4">
              <div className="w-8 h-8 border-4 border-farmsoc-light border-t-farmsoc-primary rounded-full animate-spin mx-auto"></div>
            ...
            <div className="bg-white p-4 rounded-lg shadow text-center">
              ...
              <button 
                className="mt-2 px-4 py-2 bg-farmsoc-primary text-white rounded-lg text-sm"
